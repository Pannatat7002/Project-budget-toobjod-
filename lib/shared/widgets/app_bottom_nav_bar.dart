...
import '../../features/auto_sync/presentation/state/auto_sync_state.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<AutoSyncCubit, AutoSyncState>(
      ...
      builder: (context, syncState) {
        final pendingCount = syncState.pendingTransactions.length;
        ...
        return Stack(
          ...
          children: [
                ...
                child: SizedBox(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      // Tab 1: รายการ (Right) - Shows pending bank notification badge if any
                      _buildNavItem(
                        index: 1,
            ...
            // Prominent Floating Center AI Dog Button
            Positioned(
              top: -24,
